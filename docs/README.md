...
| [Billing](runbooks/billing.md) | Hosted profile pricing, console-managed non-billable accounts, opt-in card-required 90-day trial, trial-preserving Portal, Checkout recovery, allowance enforcement, reminder setup, safe company-test webhooks, and rollout boundaries. |
