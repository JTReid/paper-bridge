...
| [Current Product Shape](runbooks/current-product-shape.md) | Implemented first-run guidance and input focus, profile, family calendar, document selection/deletion, access, sharing, and billing behavior plus focused harness commands. |
