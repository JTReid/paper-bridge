...
| Doc | Purpose |
| --- | --- |
| [Current Product Shape](runbooks/current-product-shape.md) | Implemented profile, avatar, document, access, sharing, and billing behavior plus focused harness commands. |
